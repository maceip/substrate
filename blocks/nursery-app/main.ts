...
console.log('\n=== nursery-app — four blocks composed ===')
...
const all = await (await fetch(`${listening.url}/notes`)).json()
...
// The project-wide grade dashboard at three points in the project's life.
